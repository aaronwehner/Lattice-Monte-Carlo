...
public class GrainSwitchEvent<Site extends AbstractSite & GrainSite & FixedNeighborsSite> extends AbstractEvent<Site>{
    
    private int nucleationGrainNumber;

    public GrainSwitchEvent(MonteCarlo<Site> MC){
        super(MC);
    ...
    public Double perform(){
        ...
        for(Site neighbor : (Site[]) site.getNeighbors()[0]){             
